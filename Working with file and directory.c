...
Date - 13/10/2020
Details - This console application opens/creates a txt file by the name 'filelist.txt' and then requests a directory path from user.
          Shows the files inside of that directory and saves them on a file with info like their name.
*/
#include <stdio.h>
#include <unistd.h>
#include <dirent.h>
